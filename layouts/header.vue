<template>
    <div>
        ...
        <div id="hero" class="top-content mb-8">
            ...
            <div class="md:absolute md:max-w-[391px] max-h-[588px] bg-white rounded-[4px] md:top-[132px] md:left-[73px] 2xl:top-[264px] 2xl:left-[350px] px-4 md:px-6 py-2 md:py-8">
